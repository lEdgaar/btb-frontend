...
<template>
  <b-container fluid>
    ...
    <b-form-group class="mt-3" id="input-group-1" label="Descripción Organización" label-for="input-1"
              ...
              <div style="display:flex; justify-content:space-around; width: 100%; margin: 0 auto; margin-top: 2rem;">
                ...
                <b-button style="width: 33%" @click="deteleAccount" variant="danger">Eliminar organización</b-button>
              </div>
            </b-form>
          </div>
        </b-card>
  ...
  <BModal v-model="modal" title="¿Quieres eliminar la organización?" hide-footer>
      ¿Quieres eliminar la organización?
      <br>
      <br>
